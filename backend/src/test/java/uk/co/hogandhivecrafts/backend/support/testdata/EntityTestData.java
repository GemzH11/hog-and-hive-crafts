...
/**
 * Test data factory for building populated and minimal entity instances used across tests.
 *
 * <p>The helper methods in this class provide consistent default values for `User`, `File`,
 * and `Pattern` entities so tests can create readable fixtures without repeating setup code.
 */
