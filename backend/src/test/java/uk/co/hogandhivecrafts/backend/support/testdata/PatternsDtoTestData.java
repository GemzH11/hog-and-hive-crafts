...
public class PatternsDtoTestData {
     ...
     */
    public static GetAllPatternsItem buildDefaultGetAllPatternsItem(UUID patternId, List<UUID> fileIds) {
        return new GetAllPatternsItem(patternId, PATTERN_NAME, PATTERN_CRAFT_TYPE, CREATED_DATE, UPDATED_DATE, fileIds);
    }
    ...
    public static GetAllPatternsResponse buildDefaultGetAllPatternsResponse(List<UUID> patternIds) {
        List<GetAllPatternsItem> patterns = patternIds.stream()
                .map(PatternsDtoTestData::buildDefaultGetAllPatternsItem)
                .toList();
     ...
     */
    public static GetSinglePatternResponse buildDefaultGetSinglePatternResponse(UUID patternId, List<UUID> fileIds) {
        return new GetSinglePatternResponse(patternId, PATTERN_NAME, PATTERN_SOURCE, PATTERN_CRAFT_TYPE,
                PATTERN_NOTES, CREATED_DATE, UPDATED_DATE, fileIds);
    }
    ...
    public static GetSinglePatternResponse buildDefaultGetSinglePatternResponse(UUID patternId) {
        return buildDefaultGetSinglePatternResponse(patternId, List.of(FILE_ID));
    }
    ...
    public static GetSinglePatternResponse buildDefaultGetSinglePatternResponse() {
        return buildDefaultGetSinglePatternResponse(PATTERN_ID, List.of(FILE_ID));
    }
}
