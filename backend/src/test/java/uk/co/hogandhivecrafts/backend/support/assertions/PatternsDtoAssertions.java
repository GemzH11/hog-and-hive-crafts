...
public final class PatternsDtoAssertions {
   ...
   */
  public static void assertGetAllPatternsRequestEquals(GetAllPatternsRequest actual,
                                                       GetAllPatternsRequest expected) {
   ...
   */
  public static void assertGetAllPatternsResponseEquals(GetAllPatternsResponse actual,
   ...
   */
  public static void assertGetAllPatternsItemEquals(GetAllPatternsItem actual,
                                                    GetAllPatternsItem expected) {
  ...
  public static void assertGetPatternByIdResponseEquals(GetPatternByIdResponse actual,
                                                        GetPatternByIdResponse expected) {
    Assertions.assertThat(actual.id()).isEqualTo(expected.id());
    Assertions.assertThat(actual.name()).isEqualTo(expected.name());
    Assertions.assertThat(actual.craftType()).isEqualTo(expected.craftType());
    Assertions.assertThat(actual.createdAt()).isEqualTo(expected.createdAt());
