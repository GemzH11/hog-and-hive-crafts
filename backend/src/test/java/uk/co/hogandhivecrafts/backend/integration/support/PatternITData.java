...
public class PatternITData {
  ...
  /**
   * Builds a default {@link Pattern} entity with all fields populated using the provided index to
   * generate unique values for the name, source, and notes fields.
   *
  ...
  /**
   * Builds a list of minimal {@link Pattern} entities with sequential indexes starting at
   * {@code 0}.
   *
