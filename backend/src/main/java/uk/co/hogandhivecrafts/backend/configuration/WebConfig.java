 ...
 * - API path prefix routing (/api)
 * - CORS (Cross-Origin Resource Sharing) setup for cross-origin requests
 * <p>
 * All REST controllers in the "uk.co.hogandhivecrafts.backend.controller" package
...
public class WebConfig implements WebMvcConfigurer {
     ...
     * <p>
     * This method applies the "/api" prefix to all request mappings of controllers
     ...
     * <p>
     * Enables CORS for all /api/** endpoints with the configured allowed origins.
