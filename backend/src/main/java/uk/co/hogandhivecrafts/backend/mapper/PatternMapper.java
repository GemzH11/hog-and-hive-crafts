 ...
 *
 * <p>This component handles the transformation of Pattern JPA entities into data transfer
 * objects (DTOs) used in API responses. It provides methods to map individual patterns, paginated
 * pattern lists, and detailed pattern information.
 */
@Component
public class PatternMapper {
  ...
  /**
   * Maps a page of Pattern entities to a GetAllPatternsResponse DTO containing a list of pattern
   * summaries along with pagination metadata.
   *
  ...
  /**
   * Maps a single Pattern entity to a GetPatternByIdResponse DTO for use in detailed pattern
   * retrieval responses. This DTO contains the complete pattern information including source,
